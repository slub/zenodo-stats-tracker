...
def create_january_report():
    ...
    for rid in ids:
        ...
        if response.status_code == 200:
            ...
            months_active = (diff.years * 12) + diff.months + 1 # +1 to include partial first month
    ...
    with open(OUTPUT_FILE, mode='w', newline='') as f:
        ...
        writer.writerow(["record_id", "month_views", "month_unique_views", "month_downloads", "month_unique_downloads", 
                         "all_time_views", "all_time_unique_views", "all_time_downloads", "all_time_unique_downloads"])
